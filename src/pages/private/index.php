<?php include("./src/core/index.php"); ?>
...
<body>
  ...
  <div class="container">
    <div class="row mt-4">
      <?php include "./src/pages/private/$current_path/index.php" ?>
    </div>
  </div>
  ...
  <?php
  $hasScript = file_exists("./src/pages/private/$current_path/script.php");
  if ($hasScript) include "./src/pages/private/$current_path/script.php";
  ?>
</body>
